...
<div class="page-header">
        ...
        <form action="{{ route('todos.destroy', $todo->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
            ...
            <div class="btn-group pull-right" role="group" aria-label="...">
                <a class="btn btn-warning btn-group" role="group" href="{{ route('todos.edit', $todo->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
        ...
        <div class="col-md-12">
            ...
            <form action="#">
                ...
                <div class="form-group">
                     ...
                     <p class="form-control-static">{{$todo->date}}</p>
                </div>
